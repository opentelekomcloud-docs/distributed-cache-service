...
project = 'Distributed Cache Service'
otcdocs_repo_name = 'opentelekomcloud-docs/distributed-cache-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/distributed-cache-service/best-practice/'
otcdocs_doc_title = 'Best Practice'
otcdocs_doc_type = 'best-practice'
otcdocs_service_category = 'database'
otcdocs_service_title = 'Distributed Cache Service'
otcdocs_service_type = 'dcs'
...
html_title = "Distributed Cache Service - Best Practice"
