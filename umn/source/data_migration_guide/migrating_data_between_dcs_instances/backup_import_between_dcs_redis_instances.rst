...
#. Upload the backup file to the OBS bucket.
   ...
   a. In the bucket list on the OBS console, click the name of the created bucket.
...
#. In the **Target Data** area, select the **Target Redis Instance** prepared in :ref:`Prerequisites <dcs-migration-0312004__en-us_topic_0000001893744560_section7611653155815>`.
...
#. Run the **info keyspace** command on the source and the target Redis to check the values of **keys** and **expires**.
   ...
   .. figure:: /_static/images/en-us_image_0000001990974029.png
      :alt: **Figure 1** Checking instance data

      **Figure 1** Checking instance data
