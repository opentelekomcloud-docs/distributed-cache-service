...
#. .. _dcs-migration-190703003__li423483319412:
   ...
   -  If the source and target Redis instances are on different clouds or in different regions, create a Direct Connect connection. For details, see the *Direct Connect User Guide*.
