...
On the DCS console, you can configure an automatic backup policy. The system then regularly backs up data in your instances according to the backup policy.
